...
// Employees run the work desk: dispute rounds, document checklists, notes.
// stage moves a lead through the pipeline and va reassigns ownership, so both
// stay with the admin.
const EMPLOYEE_FIELDS = new Set(['tu', 'eq', 'ex', 'docs', 'notes']);
