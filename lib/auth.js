...
const EMPLOYEE_API = [
  ...
  // per userId, so an employee can only ever read/write their own layout
  // (see GET/POST /api/dashboard-layout in server.js).
...
const EMPLOYEE_ASSETS = new Set([
  '/', '/index.html', '/production.js', '/role.js', '/logo.png', '/mfsn-logo.png', '/login.html', '/favicon.ico'
]);
