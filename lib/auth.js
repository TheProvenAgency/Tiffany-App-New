...
const EMPLOYEE_API = [
  ...
  // Deal Production and Follow-Ups. No reply-from-dashboard route exists yet,
...
const EMPLOYEE_ASSETS = new Set([
  '/', '/index.html', '/production.js', '/role.js', '/messages.js', '/logo.png', '/mfsn-logo.png', '/login.html', '/favicon.ico'
]);
