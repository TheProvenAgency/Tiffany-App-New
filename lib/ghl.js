...
async function fetchAllConversations(cfg, { max = 300 } = {}) {
  const out = [];
...
module.exports = {
  fetchAllContacts, smsByDay, testConnection, addTags, removeTags, setStatus, sendSMS, createContact, updateContact,
  fetchConversations, fetchMessages, fetchAllConversations, normalizeConversation, normalizeMessage,
  ghlFetch, _setRetry
};
